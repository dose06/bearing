...
if __name__ == "__main__":
   ...
   # ─── 모델 정의 부분 교체 ───
    ...
    print("\n MLP 모델 학습 시작...")
    model = Sequential([
        # 시퀀스 형태 (window_size, feat_dim) → Flatten 해서 (window_size*feat_dim,)로 변환
    ...
    history = model.fit(
        X_train, y_train,
        epochs=5000,               # LSTM(5000)에 비해 훨씬 적은 epoch으로도 충분할 수 있습니다
        batch_size=32,
    ...
    model.save("rul_mlp_all_sets.h5")
    print("\n💾 모델이 'rul_mlp_all_sets.h5'로 저장되었습니다.")
